...
class NewPay
{
    ...
    function __construct($merchantid = "337",
                         $secret = "F5OIhDKEN9",
    ...
    public function generate_form($orderid, $price, $customer_mail,$customer_phone,$custumvalue = "", $custumname = "") //generate form  to pay
    {
        $form = "";
        $dateexp = 10;
    ...
    public function payout_interactive($orderid, $price, $costumerinfo, $customvalues = array(), $ExtraValue = array())
    {
