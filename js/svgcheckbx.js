if( document.createElement('svg').getAttributeNS ) {
	...
	checkbxsCross.forEach( function( el, i ) { controlCheckbox( el, 'checkmark' ); } );
	radiobxsFill.forEach( function( el, i ) { controlRadiobox( el, 'checkmark' ); } );
	checkbxsCheckmark.forEach( function( el, i ) { controlCheckbox( el, 'checkmark' ); } );
	radiobxsCircle.forEach( function( el, i ) { controlRadiobox( el, 'checkmark' ); } );
	checkbxsBoxfill.forEach( function( el, i ) { controlCheckbox( el, 'checkmark' ); } );
	radiobxsSwirl.forEach( function( el, i ) { controlRadiobox( el, 'checkmark' ); } );
	checkbxsDiagonal.forEach( function( el, i ) { controlCheckbox( el, 'checkmark' ); } );
